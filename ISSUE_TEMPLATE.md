<!--- In order to make the bug fixing process easier for both the reporter and whoever has to fix the bug, I have created some guidelines about how to write an issue on the github. -->
