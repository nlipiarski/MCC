...
try:
	...
	print("File " + commands_py_name + " already deleted")

commands_json_raw_name = "commands.json"
try:
	os.remove(commands_json_raw_name)
except:
	print("File " + commands_json_raw_name + " already deleted")
...
commands_json_raw_file = open(commands_json_raw_name, "w")
